...
@Service(value="staticTaskEclapseHandler")
public class StaticTaskEclapseHandler<Map> implements EventHandler<Map> {
	private static final Logger logger = LoggerFactory.getLogger(StaticTaskEclapseHandler.class);

	@Override
	public EventType getEventType() {
		return EventType.STATIC_TASK_ECLAPSE;
	}
